  ...
  const teamMembers = [
    {
      ...
      specialization: 'Fondatoarea brandului Address Beauty, cu 7 ani experiență în predarea cursurilor',
      specializationRu: 'Основатель бренда Address Beauty, с 7-летним опытом преподавания',
