...
const courses: Course[] = [
  ...
  },
  {
    ...
    effects: ['1D', '2D', '3D', '4-6D', 'Volum', 'Efect de raze', 'Efect umed', 'Perfect line', '2 tehnici evantaie'],
    effectsRu: ['1D', '2D', '3D', '4-6D', 'Объем', 'Лучевой эффект', 'Мокрый эффект', 'Идеальная линия', '2 техники веер'],
    whatYouGet: [
  ...
  },
  {
    ...
    effects: ['1D', '2D', '3D', '4-6D', 'Volum', 'Efect de raze', 'Efect umed', 'Perfect line', 'Ombre', 'Anime', 'Lucrări comerciale'],
    effectsRu: ['1D', '2D', '3D', '4-6D', 'Объем', 'Лучевой эффект', 'Мокрый эффект', 'Идеальная линия', 'Омбре', 'Аниме', 'Коммерческие работы'],
    whatYouGet: [
